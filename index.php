...
<body>
	...
	<div id="deposit_create" class="form_box" title="create deposit">
		<form id="form_create_deposit">
			<label for="planet_id">Planet</label><select name="planet_id" id="planet_id" class="">
			<?php 
			$liste = new planet();
			...
			<label for="coord_x">coord x</label><input class="" type="text" name="coord_x" id="coord_x" placeholder="Enter deposit Size">
			<label for="coord_y">coord y</label><input class="" type="text" name="coord_y" id="coord_y" placeholder="Enter deposit Size">
